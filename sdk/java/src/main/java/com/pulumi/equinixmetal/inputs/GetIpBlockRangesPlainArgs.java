...
public final class GetIpBlockRangesPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Facility code filtering the IP blocks. Global IPv4 blcoks will be listed anyway. If you omit this and metro, all the block from the project will be listed.
     * 
     */
    ...
    /**
     * @return Metro code filtering the IP blocks. Global IPv4 blcoks will be listed anyway. If you omit this and facility, all the block from the project will be listed.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param facility Facility code filtering the IP blocks. Global IPv4 blcoks will be listed anyway. If you omit this and metro, all the block from the project will be listed.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param metro Metro code filtering the IP blocks. Global IPv4 blcoks will be listed anyway. If you omit this and facility, all the block from the project will be listed.
         * 
         * @return builder
         * 
         */
