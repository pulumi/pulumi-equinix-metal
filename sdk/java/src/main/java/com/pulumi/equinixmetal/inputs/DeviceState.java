...
import com.pulumi.equinixmetal.enums.NetworkType;
import com.pulumi.equinixmetal.enums.OperatingSystem;
import com.pulumi.equinixmetal.enums.Plan;
import com.pulumi.equinixmetal.inputs.DeviceIpAddressArgs;
import com.pulumi.equinixmetal.inputs.DeviceNetworkArgs;
import com.pulumi.equinixmetal.inputs.DevicePortArgs;
import com.pulumi.equinixmetal.inputs.DeviceReinstallArgs;
...
public final class DeviceState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param alwaysPxe If true, a device with OS `custom_ipxe` will continue to boot via iPXE on reboots.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ipxeScriptUrl URL pointing to a hosted iPXE script. More information is in the [Custom iPXE](https://metal.equinix.com/developers/docs/servers/custom-ipxe/) doc.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param networks The device&#39;s private and public IP (v4 and v6) network details. When a device is run without any special network configuration, it will have 3 networks:
         * * Public IPv4 at `metal_device.name.network.0`
         * * IPv6 at `metal_device.name.network.1`
         * * Private IPv4 at `metal_device.name.network.2`
         *   Elastic addresses then stack by type - an assigned public IPv4 will go after the management public IPv4 (to index 1), and will then shift the indices of the IPv6 and private IPv4. Assigned private IPv4 will go after the management private IPv4 (to the end of the network list).
        ...
        /**
         * @param operatingSystem The operating system slug. To find the slug, or visit [Operating Systems API docs](https://metal.equinix.com/developers/api/operatingsystems), set your API auth token in the top of the page and see JSON from the API response.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param plan The device plan slug. To find the plan slug, visit [Device plans API docs](https://metal.equinix.com/developers/api/plans), set your auth token in the top of the page and see JSON from the API response.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param projectSshKeyIds Array of IDs of the project SSH keys which should be added to the device. If you omit this, SSH keys of all the members of the parent project will be added to the device. If you specify this array, only the listed project SSH keys will be added. Project SSH keys can be created with the equinix-metal.ProjectSshKey resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param reinstall Whether the device should be reinstalled instead of destroyed when modifying user_data, custom_data, or operating system.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param storage JSON for custom partitioning. Only usable on reserved hardware. More information in in the [Custom Partitioning and RAID](https://metal.equinix.com/developers/docs/servers/custom-partitioning-raid/) doc. Please note that the disks.partitions.size attribute must be a string, not an integer. It can be a number string, or size notation string, e.g. &#34;4G&#34; or &#34;8M&#34; (for gigabytes and megabytes).
         * 
         * @return builder
         * 
         */
