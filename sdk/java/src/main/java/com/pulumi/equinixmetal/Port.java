...
import com.pulumi.equinixmetal.PortArgs;
import com.pulumi.equinixmetal.Utilities;
import com.pulumi.equinixmetal.inputs.PortState;
 ...
 * 
 */
@ResourceType(type="equinix-metal:index/port:Port")
public class Port extends com.pulumi.resources.CustomResource {
    ...
    public Port(String name, PortArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/port:Port", name, args == null ? PortArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Port(String name, Output<String> id, @Nullable PortState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/port:Port", name, state, makeResourceOptions(options, id));
    }
