...
import com.pulumi.equinixmetal.inputs.PortVlanAttachmentState;
 ...
 * 
 */
@ResourceType(type="equinix-metal:index/portVlanAttachment:PortVlanAttachment")
public class PortVlanAttachment extends com.pulumi.resources.CustomResource {
    ...
    public PortVlanAttachment(String name, PortVlanAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/portVlanAttachment:PortVlanAttachment", name, args == null ? PortVlanAttachmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PortVlanAttachment(String name, Output<String> id, @Nullable PortVlanAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/portVlanAttachment:PortVlanAttachment", name, state, makeResourceOptions(options, id));
    }
