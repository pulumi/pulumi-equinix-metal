...
import com.pulumi.equinixmetal.BgpSessionArgs;
import com.pulumi.equinixmetal.Utilities;
import com.pulumi.equinixmetal.inputs.BgpSessionState;
 ...
 * 
 */
@ResourceType(type="equinix-metal:index/bgpSession:BgpSession")
public class BgpSession extends com.pulumi.resources.CustomResource {
    ...
    public BgpSession(String name, BgpSessionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/bgpSession:BgpSession", name, args == null ? BgpSessionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private BgpSession(String name, Output<String> id, @Nullable BgpSessionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal:index/bgpSession:BgpSession", name, state, makeResourceOptions(options, id));
    }
