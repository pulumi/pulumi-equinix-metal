...
import com.pulumi.equinixmetal.ProviderArgs;
 ...
 * 
 */
@ResourceType(type="pulumi:providers:equinix-metal")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(String name, ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("equinix-metal", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
