...
public final class PortArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return UUID of a VLAN to assign as a native VLAN. It must be one of attached VLANs (from `vlan_ids` parameter), valid only for physical (non-bond) ports
     * 
     */
    ...
    /**
     * @return Behavioral setting to reset the port to default settings. For a bond port it means layer3 without vlans attached, eth ports will be bonded without native vlan and vlans attached
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param nativeVlanId UUID of a VLAN to assign as a native VLAN. It must be one of attached VLANs (from `vlan_ids` parameter), valid only for physical (non-bond) ports
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resetOnDelete Behavioral setting to reset the port to default settings. For a bond port it means layer3 without vlans attached, eth ports will be bonded without native vlan and vlans attached
         * 
         * @return builder
         * 
         */
