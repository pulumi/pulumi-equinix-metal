...
public final class DeviceReinstallArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Whether the OS disk should be filled with `00h` bytes before reinstall. Defaults to `false`.
     * 
     */
    ...
    /**
     * @return Whether the provider should favour reinstall over destroy and create. Defaults to `false`.
     * 
     */
    ...
    /**
     * @return Whether the non-OS disks should be kept or wiped during reinstall. Defaults to `false`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param deprovisionFast Whether the OS disk should be filled with `00h` bytes before reinstall. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enabled Whether the provider should favour reinstall over destroy and create. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param preserveData Whether the non-OS disks should be kept or wiped during reinstall. Defaults to `false`.
         * 
         * @return builder
         * 
         */
