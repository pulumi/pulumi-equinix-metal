...
public final class ProjectBgpConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return `private` or `public`, the `private` is likely to be usable immediately, the `public` will need to be review by Equinix Metal engineers
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param deploymentType `private` or `public`, the `private` is likely to be usable immediately, the `public` will need to be review by Equinix Metal engineers
         * 
         * @return builder
         * 
         */
