...
public final class DeviceIpAddressArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return List of UUIDs of IP block reservations from which the public IPv4 address should be taken.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param reservationIds List of UUIDs of IP block reservations from which the public IPv4 address should be taken.
         * 
         * @return builder
         * 
         */
