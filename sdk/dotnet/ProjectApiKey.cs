...
namespace Pulumi.EquinixMetal
{
    ...
    /// ```
    /// </summary>
    [EquinixMetalResourceType("equinix-metal:index/projectApiKey:ProjectApiKey")]
    public partial class ProjectApiKey : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectApiKey(string name, ProjectApiKeyArgs args, CustomResourceOptions? options = null)
            : base("equinix-metal:index/projectApiKey:ProjectApiKey", name, args ?? new ProjectApiKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectApiKey(string name, Input<string> id, ProjectApiKeyState? state = null, CustomResourceOptions? options = null)
            : base("equinix-metal:index/projectApiKey:ProjectApiKey", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectApiKeyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description string for the Project API Key resource
        /// * `read-only` - Flag indicating whether the API key shoud be read-only
