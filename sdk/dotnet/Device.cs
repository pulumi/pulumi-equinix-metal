...
namespace Pulumi.EquinixMetal
{
    ...
    public partial class Device : Pulumi.CustomResource
    {
        ...
        public Device(string name, DeviceArgs args, CustomResourceOptions? options = null)
            : base("equinix-metal:index/device:Device", name, args ?? new DeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Device(string name, Input<string> id, DeviceState? state = null, CustomResourceOptions? options = null)
            : base("equinix-metal:index/device:Device", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DeviceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.EquinixMetal.OperatingSystem> OperatingSystem { get; set; } = null!;

        /// <summary>
        /// The device plan slug. To find the plan slug, visit [Device plans API docs](https://metal.equinix.com/developers/api/plans), set your auth token in the top of the page and see JSON from the API response.
        /// </summary>
        [Input("plan", required: true)]
        public InputUnion<string, Pulumi.EquinixMetal.Plan> Plan { get; set; } = null!;
    ...
    public sealed class DeviceState : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.EquinixMetal.OperatingSystem>? OperatingSystem { get; set; }

        /// <summary>
        /// The device plan slug. To find the plan slug, visit [Device plans API docs](https://metal.equinix.com/developers/api/plans), set your auth token in the top of the page and see JSON from the API response.
        /// </summary>
        [Input("plan")]
        public InputUnion<string, Pulumi.EquinixMetal.Plan>? Plan { get; set; }
