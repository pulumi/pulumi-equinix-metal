...
class VirtualCircuitArgs:
    ...
    def nni_vlan(self) -> pulumi.Input[int]:
        """
    ...
    @nni_vlan.setter
    def nni_vlan(self, value: pulumi.Input[int]):
...
class VirtualCircuit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if nni_vlan is None and not opts.urn:
                raise TypeError("Missing required property 'nni_vlan'")
